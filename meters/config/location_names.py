...
METER_LOCATION_NAMES = {
    ...
    range(81002104, 81002104 + 1): "Walsh Upper",
    range(81002105, 81002105 + 1): "Walsh Lower",
    ...
    range(23002301, 23002399 + 1): "Walsh",
...
APP_LOCATION_NAMES = {
    ...
    range(39005, 39005 + 1): "Walsh Upper",
    range(39006, 39006 + 1): "Walsh Lower",
    ...
    range(39100, 39324 + 1): "Core",
    range(39400, 39555 + 1): "Non-Core",
    range(39560, 39570 + 1): "Toomey",
    range(39573, 39587 + 1): "Rainey",
    range(39588, 39591 + 1): "Walsh",
    range(39600, 39666 + 1): "West Campus",
    range(39700, 39751 + 1): "East Austin",
    range(39800, 39814 + 1): "Mueller",
